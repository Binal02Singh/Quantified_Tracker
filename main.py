...
from module import User as user_model, tracker, logs, db
...
def numeric_tr(username,id):
    ...
    if request.method=="GET":
        ...
        if parent_tracker.tracker_type=="Multiple Choice":
            return render_template("multiplechoice.html", tracks=all_logs, str=str, parent_tracker=parent_tracker, username=username)
